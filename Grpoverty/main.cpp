...
public:
  Player1() { loadimage(&img_player, _T("img/player_test.png"), 90, 80); }
  ...
  void Move() {
    ...
    if (cur_position.y < 0)
      cur_position.y = 0;
    if (cur_position.x + FRAME_WIDTH > Window_width)
      cur_position.x = Window_width - FRAME_WIDTH;
    if (cur_position.y + FRAME_HEIGHT > Window_height)
      cur_position.y = Window_height - FRAME_HEIGHT;
  }
...
public:
  Player2() { loadimage(&img_player, _T("img/player_test.png"), 140, 130); }
...
public:
  Player3() { loadimage(&img_player, _T("img/player_test.png"), 190, 180); }
...
public:
  Player4() { loadimage(&img_player, _T("img/player_test.png"), 210, 200); }
...
public:
  Enemy() {
    ...
    enum class SpawnEdge { Left = 0, Right };
  ...
  bool checkplayercollision1(const Player1 &player) {
    if (position.x + FRAME_WIDTH < cur_position.x ||
        position.y + FRAME_HEIGHT < cur_position.y)
      return false;
...
public:
  ...
  bool checkplayercollision1(const Player1 &player) {
    if (position.x + FRAME_WIDTH - 40 < cur_position.x ||
        position.y + FRAME_HEIGHT - 40 < cur_position.y)
      return false;
    if (position.x + 40 > cur_position.x + 90 ||
        position.y + 40 > cur_position.y + 80)
      return false;
    return true;
  }
  ...
  bool checkplayercollision2(const Player2 &player) {
    if (position.x + FRAME_WIDTH - 40 < cur_position.x ||
        position.y + FRAME_HEIGHT - 40 < cur_position.y)
      return false;
    if (position.x + 40 > cur_position.x + 140 ||
        position.y + 40 > cur_position.y + 130)
      return false;
    return true;
  }
  ...
  bool checkplayercollision3(const Player3 &player) {
    if (position.x + FRAME_WIDTH - 40 < cur_position.x ||
        position.y + FRAME_HEIGHT - 40 < cur_position.y)
      return false;
    if (position.x + 40 > cur_position.x + 190 ||
        position.y + 40 > cur_position.y + 180)
      return false;
    return true;
  }
...
public:
  ...
  bool checkplayercollision1(const Player1 &player) {
    if (position.x + FRAME_WIDTH - 60 < cur_position.x ||
        position.y + FRAME_HEIGHT - 60 < cur_position.y)
      return false;
    if (position.x + 60 > cur_position.x + 90 ||
        position.y + 60 > cur_position.y + 80)
      return false;
    return true;
  }
  ...
  bool checkplayercollision2(const Player2 &player) {
    if (position.x + FRAME_WIDTH - 60 < cur_position.x ||
        position.y + FRAME_HEIGHT - 60 < cur_position.y)
      return false;
    if (position.x + 60 > cur_position.x + 140 ||
        position.y + 60 > cur_position.y + 130)
      return false;
    return true;
  }
  ...
  bool checkplayercollision3(const Player3 &player) {
    if (position.x + FRAME_WIDTH - 60 < cur_position.x ||
        position.y + FRAME_HEIGHT - 60 < cur_position.y)
      return false;
    if (position.x + 60 > cur_position.x + 190 ||
        position.y + 60 > cur_position.y + 180)
      return false;
    return true;
  }
...
public:
  ...
  bool checkplayercollision1(const Player1 &player) {
    if (position.x + FRAME_WIDTH - 40 < cur_position.x ||
        position.y + FRAME_HEIGHT - 25 < cur_position.y)
      return false;
    if (position.x + 60 > cur_position.x + 90 ||
        position.y + 60 > cur_position.y + 80)
      return false;
...
class Button2 {
public:
  Button2(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
          LPCTSTR path_img_pushed) {
    region = rect;
...
bool cmp(paiHang a, paiHang b) { return a.score > b.score; }
...
public:
  StartGamebutton(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
                  LPCTSTR path_img_pushed)
...
protected:
  void OnClick() {
    running = true;
    if (flag_name == 0) {
      InputBox(LPTSTR(&player_name), 10, 0, _T("请输入昵称："), 0, 0, 0, false);
...
public:
  QuitGamebutton(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
                 LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
public:
  Setbutton(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
            LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
  ~Setbutton() = default;
...
public:
  Ranklist(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
           LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
  ~Ranklist() = default;
...
public:
  Gameselector(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
               LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
public:
  Housebutton(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
              LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
  ~Housebutton() = default;
...
public:
  Controlbgmopen(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
                 LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
public:
  Controlbgmquit(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
                 LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
public:
  Makerlist(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
            LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
  ~Makerlist() = default;
...
public:
  Musicbutton(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
              LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
  ~Musicbutton() = default;
...
public:
  Setupbutton(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
              LPCTSTR path_img_pushed)
...
public:
  Continuegame(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
               LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
public:
  Gameintroduction(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
                   LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
public:
  Gamechange(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
             LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
  ~Gamechange() = default;
...
public:
  Musicselector1(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
                 LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
public:
  Musicselector2(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
                 LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
public:
  Musicselector3(RECT rect, LPCTSTR path_img_idle, LPCTSTR path_img_hovered,
                 LPCTSTR path_img_pushed)
      : Button(rect, path_img_idle, path_img_hovered, path_img_pushed) {}
...
int main() {
  ...
  RECT region_gamechange, region_game_introduction, region_continuegame_button,
      region_setup_button, region_maker_list, region_bgmopen, region_bgmquit,
      region_game_selector, region_ranklist, region_start_game,
      region_quit_game, region_set_button, region_music_button,
  ...
  StartGamebutton start_game = StartGamebutton(
      region_start_game, _T("img/ui_start_idle.png"),
      _T("img/ui_start_hovered.png"), _T("img/ui_start_pushed.png"));
  QuitGamebutton quit_game = QuitGamebutton(
      region_quit_game, _T("img/ui_quit_idle.png"),
      _T("img/ui_quit_hovered.png"), _T("img/ui_quit_pushed.png"));
  Setbutton set_button =
      Setbutton(region_set_button, _T("img/ui_set_idle.jpg"),
                _T("img/ui_set_hovered.jpg"), _T("img/ui_set_pushed.jpg"));
  Musicbutton music_button = Musicbutton(
      region_music_button, _T("img/ui_music_idle.jpg"),
      _T("img/ui_music_hovered.jpg"), _T("img/ui_music_pushed.jpg"));
  Housebutton house_button = Housebutton(
      region_house_button, _T("img/ui_house_idle.jpg"),
      _T("img/ui_house_hovered.jpg"), _T("img/ui_house_pushed.jpg"));
  Musicselector1 music_selector1 = Musicselector1(
      region_music_selector1, _T("img/ui_music1_idle.jpg"),
      _T("img/ui_music1_hovered.jpg"), _T("img/ui_music1_pushed.jpg"));
  Musicselector2 music_selector2 = Musicselector2(
      region_music_selector2, _T("img/ui_music2_idle.png"),
      _T("img/ui_music2_hovered.png"), _T("img/ui_music2_pushed.png"));
  Musicselector3 music_selector3 = Musicselector3(
      region_music_selector3, _T("img/ui_music3_idle.png"),
      _T("img/ui_music3_hovered.png"), _T("img/ui_music3_pushed.png"));
  Ranklist rank_list =
      Ranklist(region_ranklist, _T("img/ui_rank_idle.jpg"),
               _T("img/ui_rank_hovered.jpg"), _T("img/ui_rank_pushed.jpg"));
  Gameselector game_selector =
      Gameselector(region_game_selector, _T("img/ui_gameselector_idle.jpg"),
                   _T("img/ui_gameselector_hovered.jpg"),
                   _T("img/ui_gameselector_pushed.jpg"));
  Controlbgmopen bgmopen = Controlbgmopen(
      region_bgmopen, _T("img/ui_bgm_open_idle.jpg"),
      _T("img/ui_bgm_open_hovered.jpg"), _T("img/ui_bgm_open_pushed.jpg"));
  Controlbgmquit bgmquit = Controlbgmquit(
      region_bgmquit, _T("img/ui_bgm_quit_idle.jpg"),
      _T("img/ui_bgm_quit_hovered.jpg"), _T("img/ui_bgm_quit_pushed.jpg"));
  Makerlist maker_list = Makerlist(
      region_maker_list, _T("img/ui_maker_list_idle.jpg"),
      _T("img/ui_maker_list_hovered.jpg"), _T("img/ui_maker_list_pushed.jpg"));
  Setupbutton setup_button =
      Setupbutton(region_setup_button, _T("img/setup.png"), _T("img/setup.png"),
                  _T("img/setup.png"));
  Continuegame continue_game = Continuegame(
      region_continuegame_button, _T("img/ui_continue_game_idle.jpg"),
      _T("img/ui_continue_game_hovered.jpg"),
      _T("img/ui_continue_game_pushed.jpg"));
  Gameintroduction game_introduction = Gameintroduction(
      region_game_introduction, _T("img/ui_game_introduction_idle.jpg"),
      _T("img/ui_game_introduction_hovered.jpg"),
      _T("img/ui_game_introduction_pushed.jpg"));
  Gamechange game_change =
      Gamechange(region_gamechange, _T("img/ui_game_change_idle.jpg"),
                 _T("img/ui_game_change_hovered.jpg"),
                 _T("img/ui_game_change_pushed.jpg"));
  ...
  loadimage(&img_selector_background, _T("img/selector_background.jpg"), 1280,
            720);
  loadimage(&img_introduction_background, _T("img/introduction.jpg"), 1280,
            720);
